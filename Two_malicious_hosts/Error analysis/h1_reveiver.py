...
def receiving(log_file):
    ...
    log_file.open("/home/amirs97/covert_channel/Two_malicious_hosts/Error_analysis/ErrorAnalysis_exp0.txt", "a")



def main():
    ErrorAnalysis_log = open("/home/amirs97/covert_channel/Two_malicious_hosts/Error_analysis/ErrorAnalysis_exp0.txt", "w")
