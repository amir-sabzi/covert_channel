...
def calibration(callibration_array,callibration_array_size):
    ...
    trainLog = open("/home/amirs97/covert_channel/Two_malicious_hosts/DNN/train_set_veryhighLoad.txt" , "w")
...
def transmission(Threshold):
    ...
    testLog = open("/home/amirs97/covert_channel/Two_malicious_hosts/DNN/test_set_veryhighLoad.txt" , "w")
...
def main():
    path_to_log = "/home/amirs97/covert_channel/Two_malicious_hosts/DNN/ErrorAnalysis_exp0_veryhighLoad.txt"
