...
def calibration(callibration_array,callibration_array_size):
    ...
    trainLog = open("/home/amirs97/covert_channel/Two_malicious_hosts/DNN/train_set.txt" , "w")
...
def transmission(Threshold):
    ...
    testLog = open("/home/amirs97/covert_channel/Two_malicious_hosts/DNN/test_set.txt" , "w")
