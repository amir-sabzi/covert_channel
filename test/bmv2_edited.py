...
class ONOSHost(CPULimitedHost):
    def __init__(self, name, inNamespace=True, **params):
        CPULimitedHost.__init__(self, name, inNamespace=inNamespace, **params)

    def config(self, **params):
        r = super(CPULimitedHost, self).config(cpu=0.2,**params)
        for off in ["rx", "tx", "sg"]:
...
class TutorialTopo(Topo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # switches
        s1 = self.addSwitch('s1', cls=ONOSBmv2Switch, cpuport=CPU_PORT,thriftport=4095)
        s2 = self.addSwitch('s2', cls=ONOSBmv2Switch, cpuport=CPU_PORT,thriftport=4096)
        s3 = self.addSwitch('s3', cls=ONOSBmv2Switch, cpuport=CPU_PORT,thriftport=4097)
        s4 = self.addSwitch('s4', cls=ONOSBmv2Switch, cpuport=CPU_PORT,thriftport=4098)
        ...
        h1 = self.addHost('h1', cls=ONOSHost, mac='00:00:00:00:00:01')
        h2 = self.addHost('h2', cls=ONOSHost, mac='00:00:00:00:00:02')
        # hosts attached to s2
        h3 = self.addHost('h3', cls=ONOSHost, mac='00:00:00:00:00:03')

        #switch-host links
        self.addLink(h3, s2,  params1={'ip' : '10.0.0.3/24' })
        self.addLink(h3, s2,  params1={'ip' : '10.0.0.4/24' , 'mac' : '00:00:00:00:00:04:'})
